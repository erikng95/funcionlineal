...
void com_diag(void)
{
    ...
    {
    flag_inv = 0;
	dibdiag(largo,grosor,pend);         		/* Dibujar linea diagonal */
    flag_inv = 1;
	dibdiag(largo,grosor,pend);               /* Dib linea diagonal inversa */
    }
    else
    {
    flag_inv = 0;
	dibdiag(grosor,ancho,pend);         		/* Dibujar linea diagonal */
    flag_inv = 1;
	dibdiag(grosor,ancho,pend);               /* Dib linea diagonal inversa */        
    }
  #endif
}
